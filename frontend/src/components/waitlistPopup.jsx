      ...
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 shadow-2xl">
        ...
        {subscribed && generatedCode ? (
          <div className="text-center">
            ...
            <button
              onClick={closePopup}
              className="w-full bg-gray-800 text-white py-2 rounded hover:bg-gray-700 transition font-semibold"
            >
              Continue Shopping
            </button>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gray-800 text-white py-2 rounded hover:bg-gray-700 transition disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
              >
